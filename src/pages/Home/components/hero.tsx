...
export function Hero() {
  return (
    <div className="wrap flex flex-wrap px-8 sml:px-[60px]">
      ...
      <div className="mt-20 xxxl:mt-0 flex w-full flex-col justify-between rounded-3xl bg-[url(/background-card-visto.svg)] bg-cover bg-top p-4 sm:bg-center sml:min-h-[900px] md:bg-top xxxl:w-[762px] xxxl:translate-x-[55px] xxxl:translate-y-[-90px]">
